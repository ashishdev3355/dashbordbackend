...
const vinRateLimiter = require("./middleware/vinRateLimiter.js");
...
const VinDecoder = require("./Dashboard/VinDecoder.js");
...
router.get('/vin-decoder', vinRateLimiter, VinDecoder);
